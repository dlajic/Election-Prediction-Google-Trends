...
-   Step 1: Collect polling data (`1_Step_1_collect_polling_data.R`)
    ...
    - Creates files "data_polls_*.csv" for data from the different polling companies.
...
-   Step 4: Generate predictions (`4_Step_4_predictive_modelling.R`)
    ...
    - This file loads the GT datasets stored in the "Data" folder and the polling data and
