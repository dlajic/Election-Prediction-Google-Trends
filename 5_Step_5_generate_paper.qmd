...
-   Step 2: Collect GT data (`2_Step_2_collect_GT_data.R`)
    - Contains the code to collect the GT data and is schedules to run every hour over a certain time period.
...
builds the different predictive models that are analyzed in the paper.
    ...
    - Create the files "data_models.csv", "data_models_sonstige.csv", "data_predictions_final_mean.csv" and "data_predictions_final_mean_sonstige.csv"
