...
elec_vlines <- as.Date(c("2005-09-18", "2009-09-27", "2013-09-18", "2017-09-24"))
...
termsCDU <- gtrends(keyword=c("CDU", "CSU", "Angela Merkel", "Christlich demokratische Union"), geo= "DE" , category=19, time = "2004-01-01 2018-01-01", gprop="web")
...
termsCSU <- gtrends(keyword=c("CSU", "christlich soziale union", "Edmund Stoiber", "Horst Seehofer"), geo= "DE" , category=19, time = "2004-01-01 2018-01-01", gprop="web")
...
termsSPD <- gtrends(keyword=c("SPD", "Sozialdemokratische Partei Deutschlands", "Frank Walter Steinmeier", "Peer Steinbrück", "Martin Schulz"), geo= "DE" , category=19, time = "2004-01-01 2018-01-01", gprop="web")
...
termsFDP <- gtrends(keyword=c("FDP", "Freie demokratische Partei Deutschlands", "Guido Westerwelle", "Philipp Rösler", "Christian Lindner"), geo= "DE" , category=19, time = "2004-01-01 2018-01-01", gprop="web")
...
termsGrün <- gtrends(keyword=c('"Grüne"',"Die Grünen", "Bündnis 90 die Grünen"), geo= "DE" , category=19, time = "2004-01-01 2018-01-01", gprop="web")
...
termsGrün_Cand <- gtrends(keyword=c("Grüne","Jürgen Trittin + Renate Künast", "Jürgen Trittin + Katrin Göring Eckardt", "Katrin Göring Eckardt + Cem Özdemir"), geo= "DE" , category=19, time = "2004-01-01 2018-01-01", gprop="web")
...
termsLinke <- gtrends(keyword=c("Linke", "Die Linke","Die Linken"), geo= "DE" , category=19, time = "2004-01-01 2018-01-01", gprop="web")
...
termsLinkeSK <- gtrends(keyword=c("Gregor Gysi", "Gregor Gysi + Sarah Wagenknecht", "Dietmar Bartsch + Sarah Wagenknecht"), geo= "DE" , category=19, time = "2004-01-01 2018-01-01", gprop="web")
...
termsAFD <- gtrends(keyword=c("AFD", "Alternative für Deutschland", "Bernd Lucke", "Alice Weidel + Alexander Gauland"), geo= "DE" , category=19, time = "2004-01-01 2018-01-01", gprop="web")
