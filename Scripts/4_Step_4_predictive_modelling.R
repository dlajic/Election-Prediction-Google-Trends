...
# load poll datasets
Infratest_Dimap_polls <- read_delim("../Data/Data_polls/data_polls_infratest_dimap.csv", delim = ";")
Forsa_polls           <- read_delim("../Data/Data_polls/data_polls_forsa.csv", delim = ";",
                                    locale = locale(decimal_mark = ","))
Kantar_polls          <- read_delim("../Data/Data_polls/data_polls_kantar.csv", delim = ";")
FGW_polls             <- read_delim("../Data/Data_polls/data_polls_fgw.csv", delim = ";",
                                    locale = locale(decimal_mark = ","))
Allensbach_polls      <- read_delim("../Data/Data_polls/data_polls_allens.csv", delim = ";",
                                    locale = locale(decimal_mark = ","))
