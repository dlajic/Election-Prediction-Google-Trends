...
#######################
### The aim is to see if there is a difference if you draw one data set for the whole time period 
###or if you draw a separate data set for each individual time distance.
######################
...
#calculating df_final for every year to compare the results
...
###Comparison if the results of the different Datasets are the same, and if not, print the difference
