...
# 1 Infratest Dimap: 6 parties ####
  ...
  write_excel_csv2(infra_dimap_all, file = "./Data_polls/data_polls_infratest_dimap.csv")
...
# 2 Allensbach ####  
  ...
  write_excel_csv2(Allens_all, file = "./Data_polls/data_polls_allens.csv")
...
# 3 FGW ####  
  ...
  write_excel_csv2(FGW_all, file = "./Data_polls/data_polls_fgw.csv")
...
# 4 Forsa ####
  ...
  write_excel_csv2(Forsa_all, file = "./Data_polls/data_polls_forsa.csv")
...
# 5 Kantar ####
  ...
  write_excel_csv2(Kantar_all, file = "./Data_polls/data_polls_kantar.csv")
