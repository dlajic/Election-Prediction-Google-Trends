...
#setwd("C:/Users/deanl/Desktop/UniMannheim/ComSocScience/Publikation/Election-Prediction-Google-Trends-main/Data")
dir <- setwd("C:/Users/deanl/Desktop/UniMannheim/ComSocScience/Publikation/Election-Prediction-Google-Trends-main/Data")
...
data_plot2 <- data_plot %>%
  filter(datasource_weight =="GT" | datasource_weight =="Only polls"
  ) %>%
  group_by(model_name) %>% 
  mutate(deviation_mean = mean(abs(deviation), na.rm=TRUE))

cols2 <- c("GT" = "red", "Only polls" = "black")
